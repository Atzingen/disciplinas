...
| 21.18 | [`21-18-desktop.png`](./21-18-desktop.png) — 1440 × 1000 | [`21-18-mobile-390x844.png`](./21-18-mobile-390x844.png) — 390 × 844 | configuração (a), com `AB = AC = r`, B/C coincidentes fisicamente e deslocamento de C rotulado como apenas esquemático |
...
- Alvos e overflow: os controles comuns e o `range` de separação do 21.42 mediram no mínimo 44 px no mobile, e nenhuma das cinco páginas apresentou overflow horizontal global em desktop ou mobile.
